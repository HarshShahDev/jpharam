export default function FeaturedProductCard({ productName = "Antiseptic Spray", discountedPrise = "$129.00", originalPrise = "$140.00" }) {
  return (
    <div className="border border-gray-300 h-[190px] p-8 flex">
      <div className="small-product-item-img">
        <a href="#"><img src="/placeholder/600x701.png" className="w-[111px] h-[131px]" alt="Image" /></a>
      </div>
      <div className="p-5">
